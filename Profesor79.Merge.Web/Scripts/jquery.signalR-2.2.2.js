...
(function($, window, undefined) {
            ...
            if (!connection._.configuredStopReconnectingTimeout) {
                ...
                connection.reconnecting(function() {
                    ...
                    if (connection.state === signalR.connectionState.reconnecting) {
                        stopReconnectingTimeout = window
                            .setTimeout(function() { onReconnectTimeout(connection); }, connection.disconnectTimeout);
                    }
                });
    ...
    function validateTransport(requestedTransport, connection) {
        ...
        ///     The connection that will be using the requested transports.  Used for
        ///     logging purposes.
        /// </param>
        /// <returns type = "Object" />
...
// This will be the sum of the TransportConnectTimeout sent in response to negotiate and connection.transportConnectTimeout
        ...
        isCrossDomain: function(url, against) {
            ...
            return link.protocol + addDefaultPort(link.protocol, link.host) !==
...
// Check to see if there is a pre-existing deferral that's being built on, if so we want to keep using it
            ...
            if (!connection.json) {
                // no JSON!
                throw new
                    Error("SignalR: No JSON parser found. Please ensure json2.js is referenced before the SignalR.js file if you need to support clients without native JSON parsing support, e.g. IE<8.");
            }
            ...
            connection._.negotiateRequest = signalR.transports._logic.ajax(connection,
            {
                ...
                success: function(result) {
                    ...
                    connection._
                        .totalTransportConnectTimeout = connection.transportConnectTimeout +
                    ...
                    if (!res.ProtocolVersion || res.ProtocolVersion !== connection.clientProtocol) {
                        protocolError = signalR._.error(signalR._
                            .format(resources.protocolIncompatible, connection.clientProtocol, res.ProtocolVersion));
        ...
        reconnecting: function(callback) {
            ...
            ///     A callback function to execute when the connection enters a reconnecting
            ///     state
            /// </param>
            /// <returns type = "signalR" />
            var connection = this;
    ...
    transportLogic = signalR.transports._logic = {
        ...
        monitorKeepAlive: function(connection) {
            ...
            if (!keepAliveData.monitoring) {
                ...
                connection.log("Now monitoring keep alive with a warning timeout of " +
        ...
        verifyLastActive: function(connection) {
            if (new Date().getTime() - connection._.lastActiveAt >= connection.reconnectWindow) {
                var message = signalR._.format(signalR.resources.reconnectWindowTimeout,
                ...
                connection.socket.onclose = function(event) {
                    ...
                    if (this === connection.socket) {
                        if (opened && typeof event.wasClean !== "undefined" && event.wasClean === false) {
                            ...
                            connection.log("Unclean disconnect from websocket: " +
                ...
                window.setTimeout(function() {
                        ...
                        if (connection.frame && transportLogic.ensureReconnectingState(connection)) {
                            var frame = connection.frame,
                                src = transportLogic.getUrl(connection, that.name, true) +
                                    "&frameId=" +
                                    connection.frameId;
            ...
            if (connection.frame) {
                if (connection.frame.stop) {
                    ...
                    try {
                        ...
                        connection.log("Error occurred when stopping foreverFrame transport. Message = " +
                            e.message +
                            ".");
                    }
                }
            ...
            privateData.pollTimeoutId = window.setTimeout(function() {
                    (function poll(instance, raiseReconnect) {
                        var messageId = instance.messageId,
                            ...
                            url = transportLogic.getUrl(instance,
                                that.name,
                                reconnecting,
                                polling,
                        ...
                        instance.pollXhr = transportLogic.ajax(connection,
                        {
                            ...
                            success: function(result) {
                                ...
                                try {
                                    ...
                                    transportLogic
                                        .handleParseFailure(instance, result, error, tryFailConnect, instance.pollXhr);
                                    return;
                                }
                            ...
                            error: function(data, textStatus) {
                                var error = signalR._
                                    .transportError(signalR.resources.longPollFailed,
                                        connection.transport,
                                        data,
                                        instance.pollXhr);
                                ...
                                if (!tryFailConnect(error)) {
                                    ...
                                    if (connection.state !== signalR.connectionState.reconnecting) {
                                        connection.log("An error occurred using longPolling. Status = " +
                                            textStatus +
                                            ".  Response = " +
                                            data.responseText +
                                            ".");
                        ...
                        if (reconnecting && raiseReconnect === true) {
                            ...
                            privateData.reconnectTimeoutId = window
                                .setTimeout(function() { fireReconnected(instance); },
...
// Check if we're removing the whole event and we didn't error because of an invalid callback
        ...
        invoke: function(methodName) {
                ...
                callback = function(minResult) {
                    ...
                    if (result.Progress) {
                        if (d.notifyWith) {
                            ...
                            connection
                                .log("A hub method invocation progress update was received but the version of jQuery in use (" + $.prototype.jquery + ") does not support progress updates. Upgrade to jQuery 1.7+ to receive progress notifications.");
            ...
            connection._.invocationCallbacks[connection._.invocationCallbackId
                .toString()] = { scope: that, method: callback };
    ...
    hubConnection.fn.init = function(url, options) {
        ...
        connection.reconnecting(function() {
            if (connection.transport && connection.transport.name === "webSockets") {
                clearInvocationCallbacks(connection,
        ...
        if (!connection._subscribedToHubs) {
            ...
            connection.starting(function() {
                ...
                if (subscribedHubs.length === 0) {
                    connection
                        .log("No hubs have been subscribed to.  The client will not receive data from hubs.  To fix, declare at least one client side function prior to connection start for each hub you wish to subscribe to.");
                }
